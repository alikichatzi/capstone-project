...
with base as (
  select *
  from `project-6ae092ab-63ed-448c-8d3.pagila_productionpublic.film_actor` 
  )
...
project_id = 'project-6ae092ab-63ed-448c-8d3'
dataset_id = 'staging_db' 
table_id = 'stg_film_actor' # Το αλλάξαμε σε actor γιατί έχουμε δεδομένα ηθοποιών
...
get_ipython().system('python -m jupyter nbconvert --to python "stg_film_actor.ipynb"')
